...
EXPECTED_RUNTIME_ARTIFACT_SOURCES = {
    ...
    "promote_stage6_acceptance.py",
    "check_p2p_feature_inventory.py",
    "stage6_evidence_contract.py",
    "isolated_network.py",
    "mdns_acceptance.py",
    "mdns_cases.py",
    "mdns_churn_cases.py",
    "mdns_evidence.py",
    "mdns_isolation_cases.py",
    "mdns_network.py",
    "mdns_phase.py",
    "mdns_staged_evidence.py",
    "autonat_cases.py",
    ...
    "forge_mdns_fixture.cpp",
    "forge_mdns_fixture.hxx",
...
EXPECTED_REGRESSION_SOURCES = {
    ...
    "test_mdns_isolation_cases.py", "test_mdns_network.py", "test_mdns_staged_evidence.py",
